...
public class Rotate_Auto_Swip : MonoBehaviour
{
    ...
    public float massA;
    public float massB;
    private Component ScriptRotate_Auto;
    ...
    private void Start()
    {
        ...
        ScriptRotate_Auto = GetComponent<Rotate_Auto>();
    }
    ...
    void Update()
    {
        ...
        if (Input.GetKey(KeyCode.S))
        {
            ...
            GetComponent<Rotate_Auto>().enabled = false;
        }
    }
}
